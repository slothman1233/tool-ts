...
import { show, addClass, hide, removeClass } from './dom';
/**
    ...
    generPageHtml: function (config: any) {
        ...
        if (this.isGoPage) {
            gopage_info = '<span class="goPageBox">' + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '">' +
                '<input type="button" id="' + this.gopageButtonId + '" onclick="kkpages_' + this.pagerid + '.gopage()" value="'
                + this.lang.gopageButtonOkText + '" />' +
                '<input type="text" id="' + this.gopageTextboxId + '" onfocus="kkpages_' + this.pagerid + '.focus_gopage()"  onkeypress="return kkpages_' + this.pagerid + '.keypress_gopage(event);"   onblur="kkpages_' + this.pagerid + '.blur_gopage()" value="' + this.next + '" /></span>' + this.lang.gopageAfterText + '</span>';
        }
